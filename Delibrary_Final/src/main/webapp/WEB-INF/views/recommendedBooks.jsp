                   ...
                   <li><a class="dropdown-item" href="popularBook.do">이달의 인기도서</a></li>
					...
					<ul id="app" class="navbar-nav ml-auto">
						...
						<c:if test="${not empty cust_no }">
							<li class="nav-item p-1"><small class="text-light">${custName}
									님</small></li>
							<li class="nav-item" v-bind:title="logout"><a
								href="logout.do?cust_no=${cust_no }" class="nav-link"><i
									class="fas fa-sign-out-alt"></i></a>
								<p class="sr-only">로그아웃</p></li>
						</c:if>
						<li class="nav-item" v-bind:title="bookcart"><a href="#"
							class="nav-link"><i class="fas fa-book"></i></a>
