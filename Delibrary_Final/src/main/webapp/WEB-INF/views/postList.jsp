		...
		<div class="container noto-serif">
		  <div class="row">
	        ...
	        <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
              	<a class="page-link" id="page-link" href="postList.do?pageNUM=${startPage-1 }&group=${group}">
									<span>&laquo;</span>
            ...
            <c:if test="${startPage == 1}">
              <li class="page-item disabled">
	            ...
	            <li class="page-item">
	             <a class="page-link" id="page-link" href="postList.do?pageNUM=${endPage+1 }&group=${group}">
								<span>&raquo;</span>
